 ...
 class Contact extends Component {
   ...
   render() {
    return(
		...
		<div className="row">
		    <Breadcrumb>
			<BreadcrumbItem><Link to="/homw">Home</Link></BreadcrumbItem>
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        ...
                        <a role="button" className="btn btn-info" href="#0" onClick={(e) => {e.preventDefault();}}><i className="fa fa-skype"></i> Skype</a>
		...
		<div className="col-12 col-md-9">
			...
			<Row className="form-group">
			    ...
			    <Col md={10}>
				<Control.text model=".telnum" id="telnum" name="telnum" className="form-control" placeholder="Tel. Num" 
